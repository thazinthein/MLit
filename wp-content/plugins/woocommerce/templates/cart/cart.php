	...
	<tbody>
		...
		<tr height="70px">
			<td colspan="6" class="actions">
				...
				<input type="submit" class="btn btn-1 btn update-btn" name="update_cart" value="<?php _e( 'Update Quote', 'woocommerce' ); ?>" /> <input type="submit" class="btn btn-1 btn checkout-btn checkout-button" name="proceed" value="<?php _e( 'Proceed to Submit &rarr;', 'woocommerce' ); ?>" />
